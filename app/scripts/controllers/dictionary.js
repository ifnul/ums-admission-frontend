      ...
      $scope.dictionaries = [
        {
          ...
          DictionariesSvc.getTimeperiodsTypes().then(function (data) {
            $scope.newData = data;
          });
        }
        },
        {
          ...
          DictionariesSvc.getSpecialtiesTypes().then(function (data) {
            $scope.newData = data;
          });
        }
        },
        {
          ...
          DictionariesSvc.getAllSpecialties().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getAllDepartments({departmentTypeId: 1}).then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getSpecoffersTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getEduformTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getBenefitsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getBenefits().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPersonsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getGenderTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getMarriedTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getAdminUnitsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getAdminUnits().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getAddressTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getContactsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPublicActivitiesTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPublicActivitiesAwards().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPublicActivities().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getEnrolmentsSubjects().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getHonorsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPaperUsages().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getPaperTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getEnrolmentsTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        },
        {
          ...
          DictionariesSvc.getEnrolmentsStatusTypes().then(function (data) {
            $scope.newData = data;
          })
        }
        }
